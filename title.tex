...
\newcommand{\Author}{Andres Felipe Orozco Gonzalez}
\newcommand{\MainTitle}{back-in-time debugger in Kotlin}
...
\publishers{%
  ...
  \begin{tabularx}{1.01\linewidth}{Xr}
    ...
    Prof. Nicolas \textsc{Cardozo Alvarez} (Promotor) & 
