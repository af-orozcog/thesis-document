...
The \textbf{view} would generate a stream of events which are in turn also translated into intents, these can be digested by the \textbf{store} that then updates its state.
